...
public class TourService {
    ...
    public TourResponse getTourById(UUID tourId) {
        return tourMapper.tourTourResponse(
                tourRepository.findById(tourId).orElseThrow(() -> new RuntimeException("Tour không tồn tại")));
    }
    ...
    public TourResponse createTour(TourCreationRequest request) {
        ...
        Cities destinationCity = citiesRepository
