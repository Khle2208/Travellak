...
public class ChartService {
    ...
    public ChartResponse getChart(){
        return ChartResponse.builder().totalBooking(bookingRepository.count()).totalTour(tourRepository.count()).totalUser(usersRepository.count()).totalRevenue(bookingRepository.getTotalRevenue("Đã thanh toán")).build();
    }
